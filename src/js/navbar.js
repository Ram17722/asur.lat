(function() {
    ...
    async function handleNavigation(path) {
        ...
        try {
            ...
            // Extract the body content using a temporary div
    ...
    // The navbar markup with clean URLs
    const navbarMarkup = `
        ...
        <nav class="navbar">
            <div class="navbar-content">
                ...
                <a href="/blogs" data-route>Blogs</a>
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <a href="/" data-route onclick="closeMenu()">Home</a>
            <a href="/blogs" data-route onclick="closeMenu()">Blogs</a>
            <a href="/projects" data-route onclick="closeMenu()">Projects</a>
            <a href="/contact" data-route onclick="closeMenu()">Contact</a>
        </div>
    `;

    // Initialize the navbar and routing
